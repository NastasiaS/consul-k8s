...
import (
	...
	catalogFromConsul "github.com/NastasiaS/consul-k8s/catalog/from-consul"
	catalogFromK8S "github.com/NastasiaS/consul-k8s/catalog/from-k8s"
	"github.com/NastasiaS/consul-k8s/helper/controller"
	"github.com/NastasiaS/consul-k8s/subcommand"
	k8sflags "github.com/NastasiaS/consul-k8s/subcommand/flags"
